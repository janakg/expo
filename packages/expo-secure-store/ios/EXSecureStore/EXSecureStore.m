...
EX_ENUM_CONVERTER(EXSecureStoreAccessible, (@{
...
EX_EXPORT_MODULE(ExpoSecureStore, nil);

EX_EXPORT_METHOD_AS(setValueWithKeyAsync:(NSString *)value
                  key:(NSString *)key
...
EX_EXPORT_METHOD_AS(getValueWithKeyAsync:(NSString *)key
                  options:(NSDictionary *)options
                  resolver:(EXPromiseResolveBlock)resolve
                  rejecter:(EXPromiseRejectBlock)reject)
{
...
EX_EXPORT_METHOD_AS(deleteValueWithKeyAsync:(NSString *)key
                  options:(NSDictionary *)options
                  resolver:(EXPromiseResolveBlock)resolve
                  rejecter:(EXPromiseRejectBlock)reject)
{
