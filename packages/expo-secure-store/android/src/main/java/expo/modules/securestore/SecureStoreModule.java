...
public class SecureStoreModule extends ExportedModule {
  ...
  private Provider sBouncyCastleProvider;
  public synchronized Provider getBouncyCastleProvider() {
  ...
  public SecureStoreModule(Context context) {
    ...
    mHybridAESEncrypter = new HybridAESEncrypter(mContextRef, mAESEncrypter);
  }
  ...
  private void setItemImpl(String key, @Nullable String value, ReadableMap options, Promise promise) {
    ...
    SharedPreferences prefs = mContextRef.getSharedPreferences(SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE);
  ...
  private void readLegacySDK20Item(String key, ReadableMap options, Promise promise) {
    SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContextRef);
  ...
  private void deleteItemImpl(String key, ReadableMap options, Promise promise) {
    ...
    SharedPreferences legacyPrefs = PreferenceManager.getDefaultSharedPreferences(mContextRef);
  ...
  private SharedPreferences getSharedPreferences() {
    return mContextRef.getSharedPreferences(SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE);
  }
  ...
  private static class HybridAESEncrypter implements KeyBasedEncrypter<PrivateKeyEntry> {
    ...
    public KeyStore.PrivateKeyEntry initializeKeyStoreEntry(KeyStore keyStore, ReadableMap options) throws GeneralSecurityException {
      ...
      Provider spongyCastleProvider = getBouncyCastleProvider();
